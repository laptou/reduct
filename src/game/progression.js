...
export const PROGRESSIONS = {
    "Elementary": {
        ...
        digraph: {
            ...
            "booleans-definition": ["lists-intro"],
            "lists-intro": ["list-basics"],
            "list-basics": ["list-counting"],
            "list-counting": ["list-filtering"],
            "list-filtering": ["lists-query"],
            "lists-query": ["lists-pair"],
            "lists-pair": ["lists-mapping"],
            "lists-mapping": ["letExpr"],
            "letExpr": ["list-sorting"],
            "list-sorting": ["higher-order-functions"],
...
export function chapterIdx() {
    let idx = 0;
    for (const chapterName of Object.values(ACTIVE_PROGRESSION_DEFINITION.progression.linearChapters)) {
